...
<svg xmlns="http://www.w3.org/2000/svg" width="${W}" height="${H}" viewBox="0 0 ${W} ${H}" fill="none">
  <defs>
    <style>
      ...
      .radar-polygon { animation: radar-pulse ${params.speed ?? '4s'} infinite ease-in-out; }
    </style>
  </defs>
  ...
  <!-- Title -->
  ${!params.hide_title ? `<text x="24" y="32" class="cp-text-fill" font-size="16" font-weight="600">${escapeXML(params.user || 'GitHub User')}'s Impact Radar</text>` : ''}
