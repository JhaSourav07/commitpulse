...
| --- | --- | --- | --- | --- | --- |
| `user` | `string` | ✅ **Yes** | — | Any valid GitHub username | `?user=jhasourav07` |
| `theme` | `string` | No | `dark` | `auto`, `dark`, `light`, `neon`, `dracula`, `github`, `gruvbox`, `neon`, `ocean`, `sunset`, `forest`, `rose`, `nord`, `synthwave`, `highcontrast`, `random` | `?theme=dracula` |
...
| `size` | `string` | No | `medium` | `small` (400×280), `medium` (600×420), `large` (800×560) | `?size=large` |
...
> > > > > > > 0fc6651 (docs(readme): add allowed values and examples to query-param matrix)
