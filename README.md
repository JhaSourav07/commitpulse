...
| ----------------- | --------- | ---------- | ------------------------------ | --------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `user`            | `string`  | ✅ **Yes** | —                              | `?user=jhasourav07`               | GitHub username to render                                                                                                                                                 |
| `theme`           | `string`  | No         | `dark`                         | `&theme=neon`                     | Preset theme name (see below)                                                                                                                                             |
| `bg`              | `hex`     | No         | Theme default                  | `&bg=0a0a0a`                      | Background color — **without** `#`                                                                                                                                        |
| `accent`          | `hex`     | No         | Theme default                  | `&accent=ff6b35`                  | Tower & glow color — **without** `#`                                                                                                                                      |
| `text`            | `hex`     | No         | Theme default                  | `&text=ffffff`                    | Label & stat text color — **without** `#`                                                                                                                                 |
| `radius`          | `number`  | No         | `8`                            | `&radius=16`                      | Border corner radius in pixels                                                                                                                                            |
| `speed`           | `string`  | No         | `8s`                           | `&speed=4s`                       | Radar scan duration (`2s`–`20s`, default `8s`)                                                                                                                            |
| `scale`           | `string`  | No         | `linear`                       | `&scale=log`                      | Tower height scaling: `linear` or `log` (logarithmic)                                                                                                                     |
| `size`            | `string`  | No         | `medium`                       | `&size=small`                     | Badge dimensions: `small` (400×280), `medium` (600×420), `large` (800×560)                                                                                                |
| `font`            | `string`  | No         | CommitPulse default typography | `&font=Orbitron`                  | Any **Google Font** name (e.g. `Orbitron`, `Inter`)                                                                                                                       |
| `refresh`         | `boolean` | No         | `false`                        | `&refresh=true`                   | Bypass cache for real-time data                                                                                                                                           |
| `year`            | `string`  | No         | —                              | `&year=2023`                      | Calendar year to render (e.g. `2023`, `2024`)                                                                                                                             |
| `hide_title`      | `boolean` | No         | `false`                        | `&hide_title=true`                | Hide GitHub username/title from the SVG badge                                                                                                                             |
| `hide_background` | `boolean` | No         | `false`                        | `&hide_background=true`           | Remove the background rect, letting the monolith float on the page                                                                                                        |
| `hide_stats`      | `boolean` | No         | `false`                        | `&hide_stats=true`                | Hides the bottom row displaying Current Streak, Annual Sync Total, and Peak Streak stats when set to `true` or `1`.                                                       |
| `tz`              | `string`  | No         | Omitted = UTC                  | `&tz=Asia/Kolkata`                | IANA timezone (e.g. `Asia/Kolkata`, `America/New_York`) — aligns "today" with the user local midnight. Note: `?tz=UTC` is valid but cached separately from omitting `tz`. |
| `lang`            | `string`  | No         | `en`                           | `&lang=es`                        | Language code for labels (`en`, `es`, `hi`, `fr`)                                                                                                                         |
