  ...
  return (
    <div ref={containerRef} className={variant === 'desktop' ? 'relative' : 'relative w-full'}>
      ...
      {variant === 'desktop' && open && (
        <div className="absolute right-0 left-0 top-full mt-5 z-50 w-80 sm:w-[450px] md:w-[520px] rounded-2xl border border-black/10 bg-white/95 p-3 shadow-2xl backdrop-blur-xl dark:border-white/10 dark:bg-[#0a0a0a]/95 animate-in fade-in slide-in-from-top-2 duration-200">
