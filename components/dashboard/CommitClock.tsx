...
export default function CommitClock({ data }: { data: CommitClockData[] }) {
  ...
  return (
    ...
    >
      ...
      <p className="text-xs text-white/50 w-full text-left mb-6 z-10">
        Your 24-hour activity cycle
      </p>
      ...
      <div className="relative w-[300px] h-[300px] flex items-center justify-center z-10">
        <svg width="300" height="300" className="rotate-[-90deg]">
          ...
          <text
            ...
            fontSize="10"
            transform={`rotate(90, ${cx + radius - 15}, ${cy + 4})`}
          >
            6h
          </text>
          <text
            ...
            fill="rgba(255,255,255,0.4)"
            fontSize="10"
            transform={`rotate(90, ${cx}, ${cy + radius - 10})`}
          >
            12h
          </text>
          <text
          ...
          <text
            ...
            fill="rgba(255,255,255,0.4)"
            fontSize="10"
            transform={`rotate(90, ${cx}, ${cy - radius + 15})`}
          >
            24h
          </text>
        </svg>
        ...
        <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
          <div className="text-center">
            <span className="block text-2xl font-bold text-transparent bg-clip-text bg-gradient-to-br from-cyan-400 to-purple-500">
              24h
            </span>
          </div>
        </div>
