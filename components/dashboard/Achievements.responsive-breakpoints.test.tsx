...
const mockAchievements = [
  { id: '1', title: 'Early Bird', description: 'Commit before 9 AM', icon: '🌅', type: 'behavior' as const, isUnlocked: true, currentValue: 5, threshold: 5, progress: 100 },
  { id: '2', title: 'Weekend Warrior', description: 'Commit on weekends', icon: '🏋️', type: 'behavior' as const, isUnlocked: false, currentValue: 3, threshold: 10, progress: 30 },
  { id: '3', title: '100 Day Streak', description: '100 consecutive days', icon: '🔥', type: 'streak' as const, isUnlocked: true, currentValue: 100, threshold: 100, progress: 100 },
  { id: '4', title: 'PR Master', description: '50 pull requests merged', icon: '🏆', type: 'contributions' as const, isUnlocked: false, currentValue: 25, threshold: 50, progress: 50 },
  { id: '5', title: 'Code Reviewer', description: 'Review 20 PRs', icon: '👁️', type: 'contributions' as const, isUnlocked: false, currentValue: 5, threshold: 20, progress: 25 },
];
...
describe('Achievements - Responsive Multi-device Columns & Mobile Viewport Layouts', () => {
  ...
  it('reflows columns using responsive grid layout on mobile viewport', () => {
    ...
    // Check that the grid container has the grid class (CSS will handle the actual display)
