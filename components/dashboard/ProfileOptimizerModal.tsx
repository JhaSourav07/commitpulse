    ...
    return (
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6">
        ...
        >
          ...
          <h2 className="text-xl font-bold text-gray-900 dark:text-white">No Profile Data Available</h2>
          <p className="text-sm text-gray-500 dark:text-gray-400 text-center">
            Profile data is required to generate optimization recommendations. Please ensure your GitHub profile information is accessible.
          </p>
          <button
            onClick={onClose}
