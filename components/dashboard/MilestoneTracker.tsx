...
export default function MilestoneTracker({
  ...
  const contributionMilestone = totalContributions >= 1000 ? 5000 : totalContributions >= 500 ? 1000 : totalContributions >= 100 ? 500 : 100;
  const streakMilestone = currentStreak >= 30 ? 100 : currentStreak >= 7 ? 30 : 7;

  const contributionPct = Math.min(100, Math.round((totalContributions / contributionMilestone) * 100));
