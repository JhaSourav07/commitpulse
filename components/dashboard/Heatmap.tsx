...
export default function Heatmap({ data }: { data: ActivityData[] }) {
  ...
  const getIntensityColor = (intensity: number) => {
    switch (intensity) {
      case 0: return 'bg-white/5'; // no activity
      case 1: return 'bg-cyan-900/50';
      case 2: return 'bg-cyan-700/80 text-cyan-200';
      case 3: return 'bg-cyan-500 shadow-[0_0_8px_rgba(6,182,212,0.6)]';
      case 4: return 'bg-purple-500 shadow-[0_0_12px_rgba(168,85,247,0.8)]';
