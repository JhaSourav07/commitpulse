    ...
    return (
      ...
      >
        <h3
          ...
          className="text-sm font-semibold text-zinc-900 dark:text-white w-full text-left mb-6 tracking-tight"
        >
  ...
  return (
    ...
    >
      <div className="w-full flex items-center justify-between mb-6">
        ...
        {username && (
          <a
            href={`/api/languages?user=${encodeURIComponent(username)}`}
            target="_blank"
            rel="noopener noreferrer"
            title="Export Language Card SVG"
            className="text-[11px] font-medium text-zinc-500 hover:text-blue-500 dark:text-zinc-400 dark:hover:text-blue-400 transition-colors flex items-center gap-1"
          >
            <svg
