            ...
            >
              <div className="relative flex-1 flex items-center">
                <input
                  ...
                  className="flex-1 rounded-xl border border-[rgba(255,255,255,0.08)] bg-[#111] px-5 py-3.5 text-sm text-white outline-none transition-all duration-200 placeholder:text-[#A1A1AA] focus-visible:ring-2 focus-visible:ring-emerald-400 focus-visible:outline-none focus:ring-2 focus:ring-[#00ffaa] focus:border-transparent"
                  value={username}
