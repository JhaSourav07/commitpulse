          ...
          <div className="grid gap-8 md:grid-cols-3 relative">
            ...
            {[
              ...
              <motion.div
                ...
                className="relative z-10 flex flex-col items-center text-center p-6 rounded-3xl border border-black/5 dark:border-white/5 bg-black/[0.03] dark:bg-black/40 backdrop-blur-xl hover:border-emerald-500/30 dark:hover:border-emerald-500/30 hover:bg-white/40 dark:hover:bg-white/[0.02] hover:shadow-[0_20px_40px_rgba(16,185,129,0.08)] dark:hover:shadow-[0_20px_40px_rgba(16,185,129,0.15)] hover:scale-[1.03] transition-all duration-500 group"
              >
                <div className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 flex items-center justify-center w-12 h-12 rounded-2xl border border-black/10 dark:border-white/10 bg-white dark:bg-zinc-950 font-bold text-sm tracking-wider text-black dark:text-white shadow-xl group-hover:border-emerald-500/30 group-hover:scale-110 transition-all duration-300">
                  <span
                    className="bg-gradient-to-br from-black to-zinc-600 dark:from-white dark:to-zinc-400 bg-clip-text text-transparent font-black"
                ...
                <h4
                  className="text-md font-bold uppercase tracking-wider text-zinc-800 dark:text-zinc-100 mt-6 mb-3 group-hover:text-emerald-500 dark:group-hover:text-emerald-400 transition-colors"
