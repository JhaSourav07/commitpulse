  ...
  return (
    <div className="flex min-h-[85vh] flex-col items-center justify-center p-4 sm:p-24 relative z-10">
      <div className="w-full max-w-md rounded-2xl border border-white/10 bg-[#12121a]/80 p-8 backdrop-blur-xl shadow-[0_8px_30px_rgb(0,0,0,0.5)]">
        ...
        <h1 className="mb-8 text-center text-3xl font-bold text-white">Welcome Back</h1>
        ...
        <form onSubmit={handleLogin} className="space-y-5">
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="block w-full rounded-xl border border-white/15 bg-white/5 py-3 pl-10 pr-4 text-white placeholder-white/40 focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500 transition"
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="block w-full rounded-xl border border-white/15 bg-white/5 py-3 pl-10 pr-10 text-white placeholder-white/40 focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500 transition"
          ...
          <button
            type="submit"
            className="w-full rounded-xl bg-[#5C45FD] py-3 text-sm font-semibold text-white shadow-lg shadow-[#5C45FD]/30 transition hover:bg-[#4a35da] hover:shadow-[#5C45FD]/50"
          >
            Sign In
          </button>
