        ...
        <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-8 px-8 py-10">
          ...
          <div className="shrink-0">
            <Link href="/customize" id="open-customization-studio-cta">
              <span className="relative inline-flex items-center gap-2 px-7 py-4 rounded-2xl font-bold text-sm text-white bg-black dark:text-black dark:bg-white hover:scale-[1.03] active:scale-[0.97] transition-transform duration-200 shadow-[0_0_30px_-4px_rgba(0,0,0,0.1)] dark:shadow-[0_0_30px_-4px_rgba(255,255,255,0.25)] cursor-pointer select-none">
                {/* Button shimmer */}
                <span
                  aria-hidden="true"
