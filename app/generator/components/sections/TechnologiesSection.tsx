                  ...
                  {['All', 'Frontend', 'Backend', 'Database', 'Styling', 'Tooling'].map((cat) => {
                    ...
                    return (
                      <button
                        ...
                        className={`px-2 py-0.5 rounded-md text-[10px] font-medium transition-all ${recCategory === cat
                      ...
                      >
                        <div className="flex items-center gap-3 px-3 py-2.5">
                          ...
                          <div className="flex items-center gap-2">
                            ...
                            <span
                              className={`px-1.5 py-0.5 rounded text-[8px] font-bold uppercase tracking-wider ${rec.strength === 'strong'
                                  ? 'bg-emerald-500/10 text-emerald-600 dark:text-emerald-400 border border-emerald-500/20'
                            ...
                            <span
                              className={`px-1.5 py-0.5 rounded text-[8px] font-bold uppercase tracking-wider ${rec.category === 'Frontend'
