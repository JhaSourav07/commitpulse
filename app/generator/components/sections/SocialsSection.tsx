        ...
        >
          {(['pick', 'links'] as const).map((tab) => (
            <button
              ...
              className={`flex-1 py-1.5 rounded-lg text-xs font-semibold transition-colors capitalize focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-500/50 ${activeTab === tab
            ...
            <div className="flex flex-wrap gap-1.5 mb-4 overflow-x-auto pb-1">
              {categories.map((cat) => (
                <button
                  ...
                  className={`px-2.5 py-1 rounded-lg text-[11px] font-medium whitespace-nowrap transition-colors ${activeCategory === cat
                ...
                <div className="flex flex-wrap gap-1.5">
                  {safeSelected.map((id) => {
                    ...
                    return (
                      <div
                        key={id}
                        className={`inline-flex items-center gap-1.5 pl-2 pr-1 py-1 rounded-lg text-[11px] border ${hasLink
              ...
              {filtered.map((social) => {
                ...
                return (
                  <button
                    ...
                    className={`flex items-center gap-3 w-full px-3 py-2.5 rounded-xl text-left text-sm transition-all ${isSelected
                  ...
                  >
                    ...
                    <span
                      className={`w-4 h-4 rounded-full border flex-shrink-0 flex items-center justify-center transition-all ${isSelected
                  ...
                  <div key={id}>
                    ...
                    <div className="relative">
                      <input
                        ...
                        className={`w-full rounded-xl border px-3 py-2 text-xs text-gray-900 dark:text-white placeholder:text-gray-400 dark:placeholder:text-white/25 bg-gray-50 dark:bg-white/5 focus:outline-none focus:ring-2 transition-colors ${hasLink
